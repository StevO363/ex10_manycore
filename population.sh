...
out_data1="data/population_GPU.csv"

for i in 100 500 1000 5000 10000 50000 100000 500000 1000000 5000000 10000000
do
    python3 csmca.py fake_randGPU.cu 10 $i >>"$out_data1"
done
